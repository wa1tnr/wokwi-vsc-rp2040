// forth.c
// getquery crufty_printer dofilldatus
...
// TODO:  validate commenting this out 20 March // #include "rp2040_reading.inc"

// TODONE: seems critical to keep it included so no - not valid to comment it out.

#include "rp2040_reading.inc"

// flash ops wants 'buffer' which iirc is declared globally in rp2040_reading.
// does it need to be global? 20 March
...
/* 1 */  Tkey, Tdup, Tlit, LIT(NEWLINE), Tnotequal, Tqbranch, OFFSET(33 /*5*/), // OFFSET(27 /*5*/)
         Tdup, Tlit, LIT(BACKSPACE), Tequal, Tqbranch,
OFFSET(18 /*3*/), // OFFSET(12 /*3*/)
         Tdrop, Tlit, LIT(BACKUP), Temit,
         Tlit, LIT(OBLIT), Temit,
         Tlit, LIT(BACKUP), Temit,
         Toneminus, Ttor, Tover, Trfrom, 
         Tumax, Tbranch, OFFSET(8 /*4*/),
/* 3 */  Tdup, Temit, Tover, Tcstore, Toneplus, Tover, Tumin,
/* 4 */  Tbranch, OFFSET(-38 /*1*/), // OFFSET(-32 /*1*/)
